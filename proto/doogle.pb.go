...
type NodeInfo struct {
	DoogleAddress        string   `protobuf:"bytes,1,opt,name=doogleAddress,proto3" json:"doogleAddress,omitempty"`
...
func (m *NodeInfo) GetDoogleAddress() string {
	if m != nil {
...
func (m *NodeCertificate) GetPublicKey() string {
	if m != nil {
		return m.PublicKey
	}
	return ""
...
func (m *NodeCertificate) GetNonce() string {
	if m != nil {
		return m.Nonce
	}
	return ""
...
func (m *FindNodeRequest) GetDoogleAddress() string {
	if m != nil {
		return m.DoogleAddress
	}
	return ""
...
var fileDescriptor_947ca98c6f36e503 = []byte{
	...
	,
}
...
type DooglleClient interface {
	...
	// health check
	Ping(ctx context.Context, in *NodeCertificate, opts ...grpc.CallOption) (*NodeCertificate, error)
...
func (c *dooglleClient) StoreItem(ctx context.Context, in *StoreItemRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/doogle.Dooglle/StoreItem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dooglleClient) FindIndex(ctx context.Context, in *FindIndexRequest, opts ...grpc.CallOption) (*FindIndexReply, error) {
	out := new(FindIndexReply)
	err := c.cc.Invoke(ctx, "/doogle.Dooglle/FindIndex", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dooglleClient) FindNode(ctx context.Context, in *FindNodeRequest, opts ...grpc.CallOption) (*FindeNodeReply, error) {
	out := new(FindeNodeReply)
	err := c.cc.Invoke(ctx, "/doogle.Dooglle/FindNode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dooglleClient) Ping(ctx context.Context, in *NodeCertificate, opts ...grpc.CallOption) (*NodeCertificate, error) {
...
func (c *dooglleClient) PingTo(ctx context.Context, in *NodeInfo, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/doogle.Dooglle/PingTo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dooglleClient) GetIndex(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*GetIndexReply, error) {
	out := new(GetIndexReply)
	err := c.cc.Invoke(ctx, "/doogle.Dooglle/GetIndex", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dooglleClient) PostUrl(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/doogle.Dooglle/PostUrl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DooglleServer interface {
	...
	// health check
	Ping(context.Context, *NodeCertificate) (*NodeCertificate, error)
	// the following endponts can be accessed from outside of the network.
...
func _Dooglle_StoreItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StoreItemRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DooglleServer).StoreItem(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/doogle.Dooglle/StoreItem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DooglleServer).StoreItem(ctx, req.(*StoreItemRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Dooglle_FindIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindIndexRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DooglleServer).FindIndex(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/doogle.Dooglle/FindIndex",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DooglleServer).FindIndex(ctx, req.(*FindIndexRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Dooglle_FindNode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindNodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DooglleServer).FindNode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/doogle.Dooglle/FindNode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DooglleServer).FindNode(ctx, req.(*FindNodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Dooglle_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DooglleServer).Ping(ctx, req.(*NodeCertificate))
	}
	return interceptor(ctx, in, info, handler)
}

func _Dooglle_PingTo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NodeInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DooglleServer).PingTo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/doogle.Dooglle/PingTo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DooglleServer).PingTo(ctx, req.(*NodeInfo))
	}
	return interceptor(ctx, in, info, handler)
}

func _Dooglle_GetIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StringMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DooglleServer).GetIndex(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/doogle.Dooglle/GetIndex",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DooglleServer).GetIndex(ctx, req.(*StringMessage))
	}
	return interceptor(ctx, in, info, handler)
}

func _Dooglle_PostUrl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StringMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DooglleServer).PostUrl(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/doogle.Dooglle/PostUrl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DooglleServer).PostUrl(ctx, req.(*StringMessage))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Dooglle_StoreItem_Handler,
		},
		{
			MethodName: "FindIndex",
			Handler:    _Dooglle_FindIndex_Handler,
		},
		{
			MethodName: "FindNode",
			Handler:    _Dooglle_FindNode_Handler,
		},
		{
			MethodName: "Ping",
		...
		{
			MethodName: "PingTo",
			Handler:    _Dooglle_PingTo_Handler,
		},
		{
			MethodName: "GetIndex",
			Handler:    _Dooglle_GetIndex_Handler,
		},
		{
			MethodName: "PostUrl",
			Handler:    _Dooglle_PostUrl_Handler,
		},
	},
